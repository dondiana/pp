...
# Font 
score_font = pg.font.SysFont("Times New Roman .ttf", 50, True, True)
big_font = pg.font.SysFont("Times New Roman .ttf", 70, True, False)
rest_font = pg.font.SysFont("Times New Roman .ttf", 50, False, False)
